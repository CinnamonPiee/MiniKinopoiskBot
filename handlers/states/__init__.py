...
from .low_coast_film_or_serial import router as low_coast_film_or_serial_router
from .random_film_serial import router as random_film_serial_router
from .main_menu import router as main_menu_router
from .height_coast_film_or_serial import router as height_coast_film_or_serial_router
...
router.include_router(low_coast_film_or_serial_router)
router.include_router(random_film_serial_router)
router.include_router(main_menu_router)
router.include_router(height_coast_film_or_serial_router)
