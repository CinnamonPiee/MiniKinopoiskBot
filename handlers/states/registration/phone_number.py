...
from utils.validations import valid_phonenumber
...
@router.message(Registration.phone_number, F.text.cast(valid_phonenumber.valid_phonenumber).as_("phone_number"))
