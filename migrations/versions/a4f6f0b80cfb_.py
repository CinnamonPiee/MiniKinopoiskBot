...
Revision ID: a4f6f0b80cfb
Revises: 
Create Date: 2024-07-23 16:01:53.310319
...
def upgrade() -> None:
    ...
    op.alter_column('films_serials_searchserial', 'picture',
               ...
               type_=sqlalchemy_utils.types.url.URLType(),
               existing_nullable=True)
    op.add_column('history_historyfilm', sa.Column('user_id', sa.BigInteger(), nullable=False))
    op.add_column('history_historyfilm', sa.Column('film_id', sa.BigInteger(), nullable=False))
    ...
    op.drop_constraint('history_historyfilm_user_id_id_1bd48924_fk_users_users_id', 'history_historyfilm', type_='foreignkey')
    op.drop_constraint('history_historyfilm_film_id_id_a32d090d_fk_films_ser', 'history_historyfilm', type_='foreignkey')
    op.create_foreign_key(None, 'history_historyfilm', 'users_users', ['user_id'], ['id'])
    op.create_foreign_key(None, 'history_historyfilm', 'films_serials_searchfilm', ['film_id'], ['id'])
    op.drop_column('history_historyfilm', 'user_id_id')
    op.drop_column('history_historyfilm', 'film_id_id')
    op.add_column('history_historyserial', sa.Column('user_id', sa.BigInteger(), nullable=False))
    op.add_column('history_historyserial', sa.Column('serial_id', sa.BigInteger(), nullable=False))
    ...
    op.drop_constraint('history_historyserial_user_id_id_0f56fe07_fk_users_users_id', 'history_historyserial', type_='foreignkey')
    op.drop_constraint('history_historyseria_serial_id_id_41b67d80_fk_films_ser', 'history_historyserial', type_='foreignkey')
    op.create_foreign_key(None, 'history_historyserial', 'users_users', ['user_id'], ['id'])
    op.create_foreign_key(None, 'history_historyserial', 'films_serials_searchserial', ['serial_id'], ['id'])
    op.drop_column('history_historyserial', 'user_id_id')
    op.drop_column('history_historyserial', 'serial_id_id')
    op.alter_column('users_users', 'id',
               existing_type=sa.BIGINT(),
               server_default=None,
               type_=sa.Integer(),
               existing_nullable=False,
               autoincrement=True)
    op.alter_column('users_users', 'name',
               existing_type=sa.VARCHAR(length=60),
               nullable=False)
    op.alter_column('users_users', 'created_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               type_=sa.DateTime(),
               existing_nullable=False)
    op.drop_index('users_users_email_3f54f4c5_like', table_name='users_users')
    op.drop_index('users_users_phone_number_4f58fde2_like', table_name='users_users')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index('users_users_phone_number_4f58fde2_like', 'users_users', ['phone_number'], unique=False)
    op.create_index('users_users_email_3f54f4c5_like', 'users_users', ['email'], unique=False)
    op.alter_column('users_users', 'created_at',
    ...
    op.alter_column('users_users', 'id',
               ...
               existing_nullable=False,
               autoincrement=True)
    op.add_column('history_historyserial', sa.Column('serial_id_id', sa.BIGINT(), autoincrement=False, nullable=False))
    op.add_column('history_historyserial', sa.Column('user_id_id', sa.BIGINT(), autoincrement=False, nullable=False))
    op.drop_constraint(None, 'history_historyserial', type_='foreignkey')
    op.drop_constraint(None, 'history_historyserial', type_='foreignkey')
    op.create_foreign_key('history_historyseria_serial_id_id_41b67d80_fk_films_ser', 'history_historyserial', 'films_serials_searchserial', ['serial_id_id'], ['id'], initially='DEFERRED', deferrable=True)
    op.create_foreign_key('history_historyserial_user_id_id_0f56fe07_fk_users_users_id', 'history_historyserial', 'users_users', ['user_id_id'], ['id'], initially='DEFERRED', deferrable=True)
    op.create_index('history_historyserial_user_id_id_0f56fe07', 'history_historyserial', ['user_id_id'], unique=False)
    op.create_index('history_historyserial_serial_id_id_41b67d80', 'history_historyserial', ['serial_id_id'], unique=False)
    op.alter_column('history_historyserial', 'created_at',
               existing_type=sa.DateTime(),
               type_=postgresql.TIMESTAMP(timezone=True),
               existing_nullable=False)
    op.alter_column('history_historyserial', 'id',
               ...
               existing_nullable=False,
               autoincrement=True)
    op.drop_column('history_historyserial', 'serial_id')
    op.drop_column('history_historyserial', 'user_id')
    op.add_column('history_historyfilm', sa.Column('film_id_id', sa.BIGINT(), autoincrement=False, nullable=False))
    op.add_column('history_historyfilm', sa.Column('user_id_id', sa.BIGINT(), autoincrement=False, nullable=False))
    op.drop_constraint(None, 'history_historyfilm', type_='foreignkey')
    op.drop_constraint(None, 'history_historyfilm', type_='foreignkey')
    op.create_foreign_key('history_historyfilm_film_id_id_a32d090d_fk_films_ser', 'history_historyfilm', 'films_serials_searchfilm', ['film_id_id'], ['id'], initially='DEFERRED', deferrable=True)
    op.create_foreign_key('history_historyfilm_user_id_id_1bd48924_fk_users_users_id', 'history_historyfilm', 'users_users', ['user_id_id'], ['id'], initially='DEFERRED', deferrable=True)
    op.create_index('history_historyfilm_user_id_id_1bd48924', 'history_historyfilm', ['user_id_id'], unique=False)
    op.create_index('history_historyfilm_film_id_id_a32d090d', 'history_historyfilm', ['film_id_id'], unique=False)
    op.alter_column('history_historyfilm', 'created_at',
               existing_type=sa.DateTime(),
               type_=postgresql.TIMESTAMP(timezone=True),
               existing_nullable=False)
    op.alter_column('history_historyfilm', 'id',
               ...
               existing_nullable=False,
               autoincrement=True)
    op.drop_column('history_historyfilm', 'film_id')
    op.drop_column('history_historyfilm', 'user_id')
    op.alter_column('films_serials_searchserial', 'picture',
